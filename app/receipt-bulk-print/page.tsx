...
export default function ReceiptBulkPrint() {
  ...
  const onPrintClick = () => {
    if (printableImages.length === 0) {
      toast.error('Silakan unggah setidaknya satu gambar untuk dicetak');
      return;
    }
    handlePrint();
  };
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              ...
              >
                ...
                <option value={2}>2 gambar (2×1)</option>
                <option value={3}>3 gambar (3×1)</option>
                <option value={4}>4 gambar (2×2)</option>
                <option value={6}>6 gambar (2×3)</option>
                <option value={8}>8 gambar (2×4)</option>
                <option value={9}>9 gambar (3×3)</option>
                <option value={12}>12 gambar (4×3)</option>
                <option value={15}>15 gambar (5×3)</option>
                <option value={16}>16 gambar (4×4)</option>
              </select>
            </div>
